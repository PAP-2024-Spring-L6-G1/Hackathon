    ...
    return (
        <div>
            ...
            { !isAuthenticated ?
                ...
                <button onClick={() => {alert("Signed out"); signOut();}} className="lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-300 text-sm text-gray-900 font-semibold rounded-xl transition duration-200">Sign Out</button>
            }
        </div>)
}